  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        {areas.map((area) => (
          <div key={area.id} className="flex items-center justify-between p-3 border border-black bg-card rounded overflow-hidden">
            {editingId === area.id ? (
              <>
                <input
                  value={editName}
    ...
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        {teamMembers.map((member) => (
          <div key={member.id} className="flex items-center justify-between p-3 border border-black bg-card rounded overflow-hidden">
            {editingId === member.id ? (
              <>
    ...
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        {metas.map((meta) => (
          <div 
            key={meta.id} 
            className={`p-3 border bg-card rounded overflow-hidden ${isMetaExpired(meta) ? 'border-destructive/50 bg-destructive/5' : 'border-black'}`}
          >
    ...
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        {actionTypes.map((type) => (
          <div key={type.id} className="flex items-center justify-between p-3 border border-black bg-card rounded overflow-hidden">
            <div className="flex items-center gap-4">
...
const ProgramaTab = () => {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        {rewards.map((reward) => (
          <div key={reward.id} className="flex items-center justify-between p-3 border border-black bg-card rounded overflow-hidden">
            {editingId === reward.id ? (
              <>
                <div className="flex items-center gap-2 flex-1">
                  <input
    ...
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        {professionalCategories.sort((a, b) => a.order - b.order).map((cat) => (
          <div key={cat.id} className="flex items-center justify-between p-3 border border-black bg-card rounded overflow-hidden">
            <div className="flex items-center gap-4">
