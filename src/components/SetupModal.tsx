...
const TiposAcaoTab = () => {
  ...
  const classLabels = { relacionamento: 'Relacionamento', venda: 'Venda', projeto: 'Projeto', seletiva: 'Seletiva', apresentacao: 'Apresentação', outro: 'Outro' };
  const validityLabels: Record<string, string> = {
        ...
        <TabsContent value="file" className="mt-4 space-y-3">
          <div className="flex items-center gap-3">
            <input
              ...
              className="hidden"
              id="setup-bulk-file-upload"
            />
            <label
              htmlFor="setup-bulk-file-upload"
        ...
        <div className="space-y-3 mt-4 pt-4 border-t border-black/20">
          ...
          <div className="flex gap-3 pt-2">
            <button
              ...
              className="btn-primary bg-card-foreground text-card disabled:opacity-40 flex items-center gap-2"
            >
